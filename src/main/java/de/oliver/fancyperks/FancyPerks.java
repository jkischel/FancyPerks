...
public class FancyPerks extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        languageConfig.addDefaultLang("version_information", "You are using <red>FancyPerks</red>, version <red>${version}</red>.");
        ...
        languageConfig.addDefaultLang("admin_deactivated_your_perk", "<red>${adminname}</red> activated your <red>${perkname}</red> perk.");
        ...
        languageConfig.addDefaultLang("perk_list_entry_active_perk", "- <green>${perkname}</green>");
        languageConfig.addDefaultLang("perk_list_entry_inactive_perk", "- <red>${perkname}</red>");
